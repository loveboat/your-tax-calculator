...
//      val result = await(controller.calculateTax(false.toString, 2016, "1100T", 1000008, "annual", None, Option(journeyId))(emptyRequest))
...
//      val result = await(controller.calculateTax(false.toString, 2016, "NT", 20000000, "annual", None, Option(journeyId))(emptyRequest))
//      status(result) shouldBe 200
...
//      val result = await(controller.calculateTax(false.toString, 2016, "BR", 20000000, "annual", None, Option(journeyId))(emptyRequest))
//      status(result) shouldBe 200
...
//      val result = await(controller.calculateTax(false.toString, 2016, "D0", 20000000, "annual", None, Option(journeyId))(emptyRequest))
//      status(result) shouldBe 200
...
//      val result = await(controller.calculateTax(false.toString, 2016, "D1", 20000000, "annual", None, Option(journeyId))(emptyRequest))
//      status(result) shouldBe 200
...
//      val result = await(controller.calculateTax(false.toString, 2016, "1100T", 9615, "weekly", Option(40), Option(journeyId))(emptyRequest))
//      status(result) shouldBe 200
...
//      val result = await(controller.calculateTax(false.toString, 2016, "SK1100", 221200, "weekly", None, Option(journeyId))(emptyRequest))
//      status(result) shouldBe 200
//      println(contentAsJson(result))
//      contentAsJson(result) shouldBe Json.toJson(TaxCalculatorTestData.hour_rate_weekly_response);
//    }
