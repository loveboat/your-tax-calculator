...
class AllowanceCalculatorSpec extends UnitSpec {
  ...
  "AllowanceCalculator calculate " should {
    "should calculate a weekly allowance" in new Setup {
    ...
    "should calculate a monthly allowance" in new Setup {
    ...
    "should calculate a annual allowance" in new Setup {
    ...
    "should calculate a zero allowance with ZERO taxCode" in new Setup {
    ...
    "should calculate a zero allowance with K0" in new Setup {
    ...
    "should calculate a zero allowance with 0L" in new Setup {
